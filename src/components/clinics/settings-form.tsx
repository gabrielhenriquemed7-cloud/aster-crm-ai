...
export function SettingsForm({ kind, initial, fields }: { kind: "document_settings" | "schedule_settings" | "ai_settings"; initial: Record<string, unknown>; fields: Field[] }) {
